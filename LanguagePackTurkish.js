...
var Languageletter25="Legend Tanıtım Videosu";		//Legend Promo Video
...
var Languageletter41b="Birleştirme zamanlayıcısı kapalı ";			//Merge timer off
var Languageletter41c="Gecikmeyi azaltmak için etkinleştirme önerildi";			//Suggested to be enabled for Lag reduce
var Languageletter41d="Virüs atış sesi";			//Virus shot sound
...
var Languageletter47="Takımın isimlerini gizle";		//Hide teammates names
...
var Languageletter61a="Jelly fizikleri";		//Jelly physics 
var Languageletter61b="Video skinler";		//Video skins
...
var Languageletter65="Gökkuşağı yemler";		//Rainbow food
...
var Languageletter87a="Hızlı çift bölünme uzaklığı";		//Quick double split range
var Languageletter87b="Yavaş çift bölünme uzaklığı";		//Slow double split range
...
var Languageletter94="Fare tuşlarını yer değiştir";		//Invert mouse buttons
...
var Languageletter96a="Sıralama mass'ını göster";		//Show leaderboard mass

var Languageletter97="Ortalanmış sıralama";		//Centered leaderboard
var Languageletter97a="Sıralama başlığı ";		//\"Leaderboard\" header 
...
var Languageletter107="Öldükten sonraki istatistikleri geç";		//Skip stats after death
...
var Languageletter117="Varayılan ayarlara dön";		//Restore default settings
...
var Languageletter194="İstatistikler";		//Stats
...
var Languageletter343="İşlevin çalışabilmesi için doldurulmalıdır";		//Must be filled for function to work.
...
var Externalletter7 = "Yazı-alanından Script Yükle"; //Load Script from Textarea
...
var Externalletter13 = "ÖNEMLİ BİLDİRİM: Çalışmayan URL'leri saklamayın, çünkü bunlar yükleme olayları olarak kullanılır. Senaryo yükleme olaylarına zarar verirse, ÇEREZLERİ SİLİN"; //IMPORTANT NOTICE: Do not keep URLs which do not work, because they are used as onload events. If Scenario damages onload events, then DELETE COOKIES
